...
const SEED_LISTINGS: SeedListing[] = [
  ...
  { title: 'Terreno edificabile Bacoli', listing_type: 'sale', property_type: 'land', status: 'active', price: 180000, address: 'Via Miliscola 200', city: 'Pozzuoli', province: 'NA', zone: 'Bacoli', cap: '80070', lat: 40.8000, lng: 14.0900, surface_sqm: 500, rooms: 0, bedrooms: 0, bathrooms: 0, floor: 0, total_floors: 0, year_built: 0, energy_class: 'G', has_elevator: false, has_parking: false, has_garden: false, has_terrace: false, has_balcony: false, has_cellar: false, has_air_conditioning: false, has_heating: false, is_furnished: false, pet_friendly: false, is_accessible: true, is_featured: false },
  ...
  { title: 'Box auto Vomero', listing_type: 'sale', property_type: 'commercial', status: 'active', price: 35000, address: 'Via Luca Giordano 45', city: 'Napoli', province: 'NA', zone: 'Vomero', cap: '80129', lat: 40.8510, lng: 14.2310, surface_sqm: 18, rooms: 1, bedrooms: 0, bathrooms: 0, floor: -1, total_floors: 0, year_built: 1980, energy_class: 'G', has_elevator: false, has_parking: true, has_garden: false, has_terrace: false, has_balcony: false, has_cellar: false, has_air_conditioning: false, has_heating: false, is_furnished: false, pet_friendly: false, is_accessible: true, is_featured: false },
]
